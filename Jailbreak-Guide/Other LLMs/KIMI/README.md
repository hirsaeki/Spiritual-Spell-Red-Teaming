...
Moonshot AI's Mixture-of-Experts model with massive 256K context window and strong agentic capabilities.
...
- **Cost:** Free tier available, API paid ($0.60/1M In, $3.00/1M Out for K2.5)
- **Intelligence:** 7/10
